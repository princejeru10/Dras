...
function widthFunctions(e) {
    ...
    if (ww > 1024) {
        ...
        $("#content").addClass("sidebar-minified");
        $("#sidebar-left").addClass("minified");
        $("#sidebar-left > div > ul > li > a > .chevron").addClass("opened").removeClass("closed");
        $("#sidebar-left > div > ul > li > a").addClass("open");
        $('#fixed').show();
        $("#main-menu-act").addClass("displayN")
    }
...
jQuery(document).ready(function(e) {
    /*e("#main-menu-act").click(function() {
        if (e(this).hasClass("full")) {*/
            ...
            e("#main-menu-act").removeClass("full").addClass("minified").find("i").removeClass("fa-angle-double-left").addClass("fa-angle-double-right");
...
function img_hl(x) {
    return x == '' || x == null ? '<center><ul class="enlarge"><li><img src="'+site.base_url+'assets/uploads/thumbs/no_image.png" alt="no-image" style="width:30px; height:30px;" class="img-circle" /><span><a href="'+site.base_url+'assets/uploads/no_image.png" data-toggle="lightbox"><img src="'+site.base_url+'assets/uploads/no_image.png" alt="no_image" style="width:200px;" class="img-thumbnail" /></a></span></li></ul></center>' : '<center><ul class="enlarge"><li><img src="'+site.base_url+'assets/uploads/thumbs/' + x + '" alt="' + x + '" style="width:30px; height:30px;" class="img-circle" /><span><a href="'+site.base_url+'assets/uploads/' + x + '" data-toggle="lightbox"><img src="'+site.base_url+'assets/uploads/' + x + '" alt="' + x + '" style="width:200px;" class="img-thumbnail" /></a></span></li></ul></center>';
...
function PoForms(){
    jQuery("#poform2").addClass("displayN");
    jQuery("#poform3").addClass("displayN");
    //jQuery("#bottom-total").addClass("displayN");
    jQuery("#showForm2").click(function(e){
        e.preventDefault();
        jQuery("#poform2").removeClass("displayN").show();
        jQuery("#poform1").addClass("displayN");
    });
    jQuery("#showForm3").click(function(e){
        e.preventDefault();
        jQuery("#poform3").removeClass("displayN").show();
        jQuery("#bottom-total").removeClass("displayN").show();
        jQuery("#poform2").addClass("displayN");
    });


    jQuery("#backtoform1").click(function(e){
        e.preventDefault();
        jQuery("#poform2").addClass("displayN");
        jQuery("#poform1").removeClass("displayN").show();
    });
    jQuery("#backtoform2").click(function(e){
        e.preventDefault();
        jQuery("#poform3").addClass("displayN");
        jQuery("#bottom-total").addClass("displayN");
        jQuery("#poform2").removeClass("displayN").show();
