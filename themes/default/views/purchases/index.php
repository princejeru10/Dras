    ...
    $(document).ready(function () {
        var oTable = $('#POData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null, null, null, null, null, {"mRender": row_status}, {"mRender": currencyFormat}, {"bSortable": false}],
            ...
            {column_number: 2, filter_default_label: "[<?=lang('jo_no');?>]", filter_type: "text", data: []},
            {column_number: 3, filter_default_label: "[<?=lang('customer');?>]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('warehouse');?>]", filter_type: "text", data: []},
             {column_number: 5, filter_default_label: "[<?=lang('customer_po');?>]", filter_type: "text", data: []},
             {column_number: 6, filter_default_label: "[<?=lang('supplier_po');?>]", filter_type: "text", data: []},
                ...
                <div class="table-responsive">
                    <table id="POData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
                            ...
                            <th><?php echo $this->lang->line("jo_no"); ?></th>
                            <th><?php echo $this->lang->line("customer"); ?></th>
                            <th><?php echo $this->lang->line("warehouse"); ?></th>
                             <th><?php echo $this->lang->line("customer_po"); ?></th> 
                             <th><?php echo $this->lang->line("supplier_po"); ?></th> 
