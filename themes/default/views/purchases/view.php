            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<?= site_url('purchases/receive/' . $inv->id) ?>"><i
                                        class="fa fa-edit"></i> <?= lang('purchases_receive') ?></a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="well well-sm">
                    ...
                    <div class="col-xs-4 border-right border-left">

                        <div class="col-xs-2"><i class="fa fa-3x fa-file-text-o padding010 text-muted"></i></div>
                        <div class="col-xs-10">
                            <h2 class=""><?= lang("jo_no"); ?>: <?= $inv->reference_no; ?></h2>
                              <p style="font-weight:bold;"><?= lang("invoice_no"); ?>: <?= $inv->invoice_no; ?></p>
                            <p style="font-weight:bold;"><?= lang("rr_no"); ?>: <?= $inv->rr_no; ?></p>
                            <p style="font-weight:bold;"><?= lang("mrf_no"); ?>: <?= $inv->mrf_no; ?></p>
                            <p style="font-weight:bold;"><?= lang("customer_po"); ?>: <?= $inv->customer_po; ?></p>
                            <p style="font-weight:bold;"><?= lang("supplier_po"); ?>: <?= $inv->supplier_po; ?></p>
                            <p style="font-weight:bold;"><?= lang("date"); ?>: <?= $this->sma->hrld($inv->date); ?></p>
                            <p style="font-weight:bold;"><?= lang("status"); ?>: <?= $inv->status; ?></p>
                            <!-- <p style="font-weight:bold;"><?= lang("received_by"); ?>: <?= $inv->received_by; ?></p> -->
                        </div>
                        <div class="col-xs-12">
                    ...
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                <td style="width: 220px; text-align:center; vertical-align:middle;"><?= $this->sma->formatNumber($row->quantity); ?></td>
                                <td style="width: 120px; text-align:center; vertical-align:middle;"><?= $this->sma->formatNumber($row->quantity - $row->received); ?></td>
...
<!--                                class="hidden-sm hidden-xs"><?//= lang('email') ?><!--</span></a></div>-->
                    ...
                    <div class="btn-group"><a href="<?= site_url('purchases/receive/' . $inv->id) ?>"
                                              class="tip btn btn-warning tip" title="<?= lang('receive') ?>"><i
                                    class="fa fa-edit"></i> <span class="hidden-sm hidden-xs"><?= lang('receive') ?></span></a>
                    </div>
