...
//        localStorage.setItem('prfno', '<?//=$inv->po_no?>//');
        localStorage.setItem("poaction","edit");
    ...
    localStorage.setItem('requested_by', '<?=$inv->requested_by?>');
...
<!--                                    </div>-->
                        ...
                        <div id="poform2-1"> 
                            ...
                            <!-- <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("po_no", "pono"); ?>
                                    <?php echo form_input('po_no', (isset($_POST['po_no']) ? $_POST['po_no'] : $po_no), 'class="form-control input-tip" id="pono" required="required"'); ?>
                                </div>
                            </div>
...
<!-- 
                            <div class="col-md-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <?php echo form_submit('edit_pruchase', $this->lang->line("submit"), 'id="edit_pruchase" class="btn btn-success" style="padding: 6px 15px; margin:15px 0;"'); ?>
