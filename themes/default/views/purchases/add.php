<script type="text/javascript">
    ...
    <?php } ?>
    localStorage.setItem('poaction',"add");
...
<!--        }-->
        ...
        $("#add_item").autocomplete({
            ...
            response: function (event, ui) {
                ...
                else if (ui.content.length == 16 && ui.content[0].id != 0) {
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12" id="poform1-1">
                            <div class="panel panel-warning">
                                <div
                                    class="panel-heading"><?= lang('Please_complete_these_before_adding_product') ?></div>
...
//                                                $wh[$supplier->id] = $supplier->company;
//                                            }
//                                            echo form_dropdown('supplier', $wh, (isset($_POST['supplier']) ? $_POST['supplier'] : $Settings->default_supplier), 'id="posupplier" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("supplier") . '" required="required" style="width:100%;" ');
//                                            ?><!--       -->
...
<!--                                        <div class="form-group">-->
<!--                                            --><?//= lang("prf_no", "pono"); ?>
<!--                                            --><?php //echo form_input('po_no', (isset($_POST['po_no']) ? $_POST['po_no'] : ""), 'class="form-control input-tip" id="pono" required="required"'); ?>
<!--                                        </div>-->
<!--                                    </div>-->
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?= lang("customer_po", "customer_po"); ?>
                                            <?php echo form_input('customer_po', (isset($_POST['customer_po']) ? $_POST['customer_po'] : ""), 'class="form-control input-tip" id="customer_po" required="required"'); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?= lang("requested_by", "porequestedby"); ?>
                                            <?php echo form_input('requested_by', (isset($_POST['requested_by']) ? $_POST['requested_by'] : ""), 'class="form-control input-tip" id="porequestedby" required="required"'); ?>
                                        </div>
                                    </div>
                ...
                <!--                            <td>--><?//= lang('discount') ?><!-- <span class="totals_val pull-right" id="tds">0.00</span></td>-->
                            ...
                            <!--<div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('invoice_no', (isset($_POST['invoice_no']) ? $_POST['invoice_no'] : ""), 'class="form-control input-tip" id="invoiceno" required="required"'); ?>
                                </div>
                            </div>-->
                            ...
                            <div class="col-md-4">
                                <!--<div class="form-group">
                                    ...
                                    <?php
                                    $post = array('pending' => lang('pending for approval'));
                            ...
                            <div class="col-md-4">
                                <!--<div class="form-group">
                                    ...
                                    <?php echo form_input('received_by', (isset($_POST['received_by']) ? $_POST['received_by'] : ""), 'class="form-control input-tip" id="poreceivedby" required="required"'); ?>
                                </div>-->
                            </div>
                            <div class="col-md-12">
                                <div
                                    ...
                                    <?php echo form_submit('add_pruchase', $this->lang->line("submit"), 'id="add_pruchase" class="btn btn-success" style="padding: 6px 15px; margin:15px 0;"'); ?>
