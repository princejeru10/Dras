                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="checkbox" value="1" id="purchases-receive" class="checkbox"
                                               name="purchases-receive" <?php echo $p->{'purchases-receive'} ? "checked" : ''; ?>><label
                                            for="purchases-receive" class="padding05"><?= lang('purchases_receive') ?></label>
