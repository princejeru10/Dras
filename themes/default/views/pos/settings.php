<div class="box">
    <div class="box-header">
        ...
        <?php if(isset($pos->purchase_code) && ! empty($pos->purchase_code)) { ?> 
        <div class="box-icon">
            <ul class="btn-tasks">
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                            ...
                            <?= form_input('customer', (isset($_POST['customer']) ? $_POST['customer'] : ""), 'id="customer1" data-placeholder="' . lang("select") . ' ' . lang("customer") . '" required="required" class="form-control" style="width:100%;"'); ?>
                        </div>
                    </div>
