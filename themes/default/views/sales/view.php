            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('sales/edit/' . $inv->id) ?>" class="sledit"><i
                                    class="fa fa-edit"></i> <?= lang('edit_sale') ?></a></li>
                        <li><a href="<?= site_url('sales/payments/' . $inv->id) ?>" data-target="#myModal"
                               data-toggle="modal"><i class="fa fa-money"></i> <?= lang('view_payments') ?></a></li>
                        <li><a href="<?= site_url('sales/add_payment/' . $inv->id) ?>" data-target="#myModal"
                               data-toggle="modal"><i class="fa fa-money"></i> <?= lang('add_payment') ?></a></li>
<!--                        <li><a href="<?//= site_url('sales/add_delivery/' . $inv->id) ?><!--" data-target="#myModal"-->
<!--                               data-toggle="modal"><i class="fa fa-truck"></i> <?//= lang('add_delivery') ?><!--</a></li>-->
<!--                        <li><a href="<?//= site_url('sales/email/' . $inv->id) ?><!--" data-target="#myModal"-->
<!--                               data-toggle="modal"><i class="fa fa-envelope-o"></i> <?//= lang('send_email') ?><!--</a></li>-->
                        <li><a href="<?= site_url('sales/pdf/' . $inv->id) ?>"><i
                                    class="fa fa-file-pdf-o"></i> <?= lang('export_to_pdf') ?></a></li>
                        <li><a href="<?= site_url('sales/return_sale/' . $inv->id) ?>"><i
                                    class="fa fa-reply"></i> <?= lang('return_sale') ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<!--                    </div>-->
                    ...
                    <div class="col-xs-4">
                        ...
                        <div class="col-xs-10">
                            <h2 class=""><?= lang("do_reference_no"); ?>: <?= $inv->reference_no; ?></h2>

                            <p style="font-weight:bold;"><?= lang("mrf_no"); ?>: <?= $inv->mrf_no; ?></p>
                            <p style="font-weight:bold;"><?= lang("jo_no"); ?>: <?= $inv->jo_no; ?></p>
