<script>
    $(document).ready(function () {
        var oTable = $('#RESLData').dataTable({
            ...
            "aoColumns": [{"mRender": fld}, null, null, null,  {"mRender": currencyFormat}, {
                "bSortable": false,
                "bVisible": false,
                "mRender": checkbox
...
//                nCells[4].innerHTML = currencyFormat(parseFloat(sc));
            ...
            {column_number: 1, filter_default_label: "[<?=lang('re_no');?>]", filter_type: "text", data: []},
                ...
                <div class="table-responsive">
                    <table id="RESLData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line("re_no"); ?></th>
