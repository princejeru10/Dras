<script type="text/javascript">
    var inclusive_tax_price_calculation = <?= $Settings->price_cal; ?>,
        count = 1, an = 1, product_variant = 0, DT = <?= $Settings->default_tax_rate ?>,
    ...
    $(document).ready(function () {
        ...
        localStorage.setItem('jo_no', '<?= $inv->jo_no ?>');
        localStorage.setItem('mrf_no', '<?= $inv->mrf_no ?>');
        localStorage.setItem('customer_po', '<?= $inv->customer_po ?>');
        localStorage.setItem('prepared_by', '<?= $inv->prepared_by ?>');
        localStorage.setItem('issued_to', '<?= $inv->issued_to ?>');
...
<!--                                    --><?php //if (!$Settings->restrict_user || $Owner || $Admin) { ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?= lang("mrf_no", "mrfno"); ?>
                                            <?php echo form_input('mrf_no', (isset($_POST['mrf_no']) ? $_POST['mrf_no'] : $slnumber), 'class="form-control input-tip" id="mrfno" required="required"'); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?= lang("jo_no", "jono"); ?>
                                            <?php echo form_input('jo_no', (isset($_POST['jo_no']) ? $_POST['jo_no'] : $slnumber), 'class="form-control input-tip" id="jono" required="required"'); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input('customer_po', (isset($_POST['customer_po']) ? $_POST['customer_po'] : $slnumber), 'class="form-control input-tip" id="customer_po" required="required"'); ?>
                                        </div>
                                    </div>
...
//                                    } ?>-->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input('prepared_by','', 'class="form-control input-tip" required="required" id="prepared_by"'); ?>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <?= lang("issued_to", "issued_to"); ?>
                                            <?php echo form_input('issued_to','', 'class="form-control input-tip" required="required" id="issued_to"'); ?>
