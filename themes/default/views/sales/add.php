                            ...
                            <div class="panel panel-warning">
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?= lang("jo_no", "jono"); ?>
                                            <?php echo form_input('jo_no', (isset($_POST['jo_no']) ? $_POST['jo_no'] : $jo_no), 'class="form-control input-tip" id="jono" required="required"'); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input('customer_po', (isset($_POST['customer_po']) ? $_POST['customer_po'] : $jo_no), 'class="form-control input-tip" id="customer_po" required="required"'); ?>
                                        </div>
                                    </div>
                                    <?php //if (!$Settings->restrict_user || $Owner || $Admin) { ?>
                                        <div class="col-md-4">
