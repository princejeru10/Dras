    ...
    $(document).ready(function () {
        var oTable = $('#SLData').dataTable({
            ...
            "aoColumns": [{
                ...
                "mRender": checkbox,
                "sWidth": "5%"
            }, {"mRender": fld}, null,  null, {"mRender": row_status}, null, {"mRender" : htmlFormat}, {"mRender": currencyFormat}, {"bSortable": false}],
...
//            {column_number: 3, filter_default_label: "[<?//=lang('biller');?>//]", filter_type: "text", data: []},
            ...
            {column_number: 6, filter_default_label: "[<?=lang('notes');?>]", filter_type: "text", data: []},
        ], "footer");
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?= lang('deliveries') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?>
        </h2>
