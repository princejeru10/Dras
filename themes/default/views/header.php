...
<!--                    </li>-->
                    ...
                    <?php if (($Owner || $Admin) && $qty_alert_num > 0) { ?>
                        <li class="dropdown hidden-xs"><a class="btn blightOrange tip" title="<?= lang('alerts') ?>"
                                                          data-placement="left"
                                                          href="<?= site_url('reports/quantity_alerts') ?>"><i
                                class="fa fa-exclamation-triangle"></i><span
                                class="number bwhite black"><?= $qty_alert_num; ?></span></a></li><?php } ?>
                    <?php if (POS) { ?>
...
<!--                                    <li id="products_receiving"><a class="submenu" href="--><?//= site_url('products/receive_item'); ?><!--"><i-->
<!--                                                class="fa fa-plus-circle"></i><span-->
<!--                                                class="text"> --><?//= lang('receive_item'); ?><!--</span></a></li>-->
<!--                                    <li id="products_dr"><a class="submenu" href="--><?//= site_url('products/dr_form'); ?><!--"><i-->
<!--                                                class="fa fa-plus-circle"></i><span-->
<!--                                                class="text"> --><?//= lang('dr_form'); ?><!--</span></a></li>-->
<!--                                    <li id="products_rms"><a class="submenu" href="--><?//= site_url('products/return_material'); ?><!--"><i-->
<!--                                                class="fa fa-reply"></i><span-->
<!--                                                class="text"> --><?//= lang('return_material'); ?><!--</span></a></li>-->
...
<!--                            <li class="mm_tools <?= strtolower($this->router->fetch_method()) == 'settings' ? '' : 'mm_pos' ?>">
                                <a class="dropmenu" href="#"><i class="fa fa-wrench"></i><span
                                        class="text"> <?= lang('tools'); ?> </span> <span class="chevron closed"></span></a>
                                <ul>

                                    <li id="tools_index"><a class="submenu" href="<?= site_url('tools'); ?>"><i
                                                class="fa fa-wrench"></i><span
                                                class="text"> <?= lang('list_tools'); ?></span></a></li>
                                    <li id="tools_add"><a class="submenu" href="<?= site_url('tools/add'); ?>"><i
                                                class="fa fa-plus-circle"></i><span
                                                class="text"> <?= lang('add_tool'); ?></span></a></li>
                                    <li id="tools_out"><a class="submenu" href="<?= site_url('tools/lend'); ?>"><i
                                                class="fa fa-arrow-left"></i><span
                                                class="text"> <?= lang('lend_tools'); ?></span></a></li>
                                    <li id="tools_return_tools"><a class="submenu"
                                                                   href="<?= site_url('tools/return_tools'); ?>"><i
                                                class="fa fa-reply"></i><span
                                                class="text"> <?= lang('return_tools'); ?></span></a></li>
                                </ul>
                            </li>-->
...
<!--                                    --><?php //} ?>
                                    ...
                                    <li id="reports_products"><a href="<?= site_url('reports/products') ?>"><i
                                                class="fa fa-barcode"></i><span
                                                class="text"> <?= lang('product_history_report'); ?></span></a></li>
...
<!--                                                class="text"> --><?//= lang('purchases_report'); ?><!--</span></a></li>-->
                                    <li id="reports_customer_report"><a href="<?= site_url('reports/customers') ?>"><i
                                                class="fa fa-users"></i><span
                                                class="text"> <?= lang('delivery_report'); ?></span></a></li>
