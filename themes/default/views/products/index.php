...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            {column_number: 6, filter_default_label: "[<?=lang('product_cost');?>]", filter_type: "text", data: []},
            ...
            {column_number: 9, filter_default_label: "[<?=lang('pending');?>]", filter_type: "text", data: []},
            {column_number: 10, filter_default_label: "[<?=lang('alert_quantity');?>]", filter_type: "text", data: []},
            {column_number: 11, filter_default_label: "[<?=lang('purchaseqty');?>]", filter_type: "text", data: []}
        ], "footer");
