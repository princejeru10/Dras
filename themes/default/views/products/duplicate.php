...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-edit"></i><?= lang('duplicate_product'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("products/duplicate/" . $product->id, $attrib)
                ?>
                <div class="col-md-5">
                    ...
                    <div class="form-group all">
                        ...
                        <?= form_input('brand', (isset($_POST['brand']) ? $_POST['brand'] : ($product ? $product->brand : '')), 'class="form-control" id="brand" required="required"'); ?>
                    </div>
                    <div class="form-group all">
                    ...
                    <div class="standard">
                        <div class="<?= $product ? 'text-warning' : '' ?>">
                            ...
                            if (!empty($warehouses) || !empty($warehouses_products)) {
                                echo '<div class="row"><div class="col-md-12"><div class="well"><button type="button" class="btn btn-xs btn-danger pull-right tip" title="' . lang('close') . '" id="disable_wh"><i class="fa fa-times"></i></button><button type="button" class="btn btn-xs btn-warning pull-right tip" title="' . lang('duplicate') . '" id="enable_wh"><i class="fa fa-edit"></i></button>';
