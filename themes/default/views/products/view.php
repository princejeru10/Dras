...
<!--        <li class=""><a href="#chart" class="tab-grey"><?//= lang('chart') ?><!--</a></li>-->
            <li class=""><a href="#sales" class="tab-grey"><?= lang('deliveries') ?></a></li>
                    ...
                    <ul class="btn-tasks">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu"
                                ...
                                <li><a href="<?= site_url('products/add/' . $product->id) ?>"><i
                                            class="fa fa-edit"></i> <?= lang('duplicate') ?></a></li>
                                <li>
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <img src="<?= $product->image == '' ? base_url() . 'assets/uploads/no_image.png' : base_url() .  'assets/uploads/' . $product->image ?>"
...
//                                            }
                        ...
                        <div class="buttons">
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group"><a href="<?= site_url('products/add/' . $product->id) ?>"
                                                          class="tip btn btn-primary tip"
                                                          title="<?= lang('duplicate') ?>"><i class="fa fa-edit"></i>
                                        <span class="hidden-sm hidden-xs"><?= lang('duplicate') ?></span></a></div>
