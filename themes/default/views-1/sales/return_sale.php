            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("do_reference_no", "dr_no"); ?>
                                <?php echo form_input('dr_no', (isset($_POST['dr_no']) ? $_POST['dr_no'] : ''), 'class="form-control input-tip" id="dr_no" required="required"'); ?>
                            </div>
                        </div>
<!--                        <div class="col-md-4">-->
<!--                            <div class="form-group">-->
...
<!--                        </div>-->
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('warehouse_id', $wh, (isset($_POST['warehouse_id']) ? $_POST['warehouse_id'] : ''), 'id="warehouse_id" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("to_warehouse") . '" required="required" style="width:100%;" ');
                                ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("returned_by", "returned_by"); ?>
                                <?php echo form_input('returned_by', (isset($_POST['returned_by']) ? $_POST['returned_by'] : ''), 'class="form-control input-tip" id="returned_by" required="required"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('received_by', (isset($_POST['received_by']) ? $_POST['received_by'] : ''), 'class="form-control input-tip" id="received_by" required="required"'); ?>
                            </div>
                        </div>
