    ...
    $(document).ready(function () {
        var oTable = $('#POData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null, null, null, {"mRender": row_status}, {"mRender": currencyFormat}, {"bSortable": false}],
            ...
            {column_number: 6, filter_default_label: "[<?=lang('grand_total');?>]", filter_type: "text", data: []},
        ], "footer");
