            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-group all">
                        ...
                        <?= form_input('brand', (isset($_POST['brand']) ? $_POST['brand'] : ($product ? $product->brand : '')), 'class="form-control" id="brand"'); ?>
                    </div>
                    <div class="form-group all">
...
<!--                                   id="attributes" <?php //= $this->input->post('attributes') || $product_options ? 'checked="checked"' : ''; ?><!--><label-->
<!--                                for="attributes"-->
<!--                                class="padding05"><?php//= lang('product_has_attributes'); ?><!--</label> <?php//= lang('eg_sizes_colors'); ?>
<!--                        </div>-->
<!--                        <div class="well well-sm" id="attr-con"-->
<!--                             style="<?php //= $this->input->post('attributes') || $product_options ? '' : 'display:none;'; ?><!--">-->
...
<!--                                       style="<?php//= $this->input->post('attributes') || $product_options ? '' : 'display:none;'; ?><!--margin-bottom: 0; margin-top: 10px;">-->
<!--                                    <thead>-->
<!--                                    <tr class="active">-->
<!--                                        <th><?php//= lang('name') ?><!--</th>-->
<!--                                        <th><?php//= lang('warehouse') ?><!--</th>-->
...
<!---->
<!--                        <div class="form-group">-->
<!--                            <?php//= lang("add_product", "add_item") . ' (' . lang('not_with_variants') . ')'; ?>
...
<!--                            <label class="table-label" for="combo"><?php//= lang("combo_products"); ?><!--</label>-->
<!---->
...
<!--                                    <thead>-->
<!--                                    <tr>-->
<!--                                        <th class="col-md-5 col-sm-5 col-xs-5"><?php//= lang("product_name") . " (" . $this->lang->line("product_code") . ")"; ?><!--</th>-->
<!--                                        <th class="col-md-2 col-sm-2 col-xs-2"><?php//= lang("quantity"); ?><!--</th>-->
<!--                                        <th class="col-md-3 col-sm-3 col-xs-3"><?php//= lang("unit_price"); ?><!--</th>-->
...
<!--                               value="" <?php//= isset($_POST['cf']) ? 'checked="checked"' : '' ?><!--/><label for="extras"-->
<!--                                                                                                      class="padding05"><?php//= lang('custom_fields') ?><!--</label>-->
<!--                    </div>-->
...
<!--                            <div class="form-group all">-->
<!--                                <?php//= lang('pcf5', 'cf5') ?>
<!--                                <?php//= form_input('cf5', (isset($_POST['cf5']) ? $_POST['cf5'] : ($product ? $product->cf5 : '')), 'class="form-control tip" id="cf5"') ?>
<!--                            </div>-->
<!--                        </div>-->
<!---->
<!--                        <div class="col-md-4">-->
<!--                            <div class="form-group all">-->
<!--                                <?php//= lang('pcf6', 'cf6') ?>
<!--                                <?php//= form_input('cf6', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control tip" id="cf6"') ?>
<!--                            </div>-->
<!--                        </div>-->
<!---->
<!--                    </div>-->
...
<!--                    </div>-->
<!--                    <div class="form-group all">-->
<!--                        <?php//= lang("product_details_for_invoice", "details") ?>
<!--                        <?php//= form_textarea('details', (isset($_POST['details']) ? $_POST['details'] : ($product ? $product->details : '')), 'class="form-control" id="details"'); ?>
<!--                    </div>-->
