        ...
        if ($this->db->update('purchases', $data, array('id' => $id)) && $this->db->delete('purchase_items', array('purchase_id' => $id))) {
            ...
            foreach ($items as $item) {
                ...
                if ($data['status'] == 'complete' || $data['status'] == 'partial') {
                    $this->updateProductQuantity($item['product_id'], $item['received'], $item['warehouse_id'], $item['net_unit_cost']);
                    if (isset($item['option_id']) && !empty($item['option_id'])) {
                        $this->addProductOptionQuantity($item['option_id'], $item['warehouse_id'], $item['received'], $item['product_id']);
                        $this->site->syncVariantQty($item['option_id']);
                    }
                }
            }
